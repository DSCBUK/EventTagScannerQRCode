...
public class MainActivity extends AppCompatActivity {
    ...
    FirebaseFirestore ForloopKanoDB = FirebaseFirestore.getInstance();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mFireStore.collection("ForloopKano").addSnapshotListener(new EventListener<QuerySnapshot>() {
            @Override
                ...
                AttendeeCodeID.post(new Runnable() {
                    ...
                    public void run() {
                        ...
                        if (!TextUtils.isEmpty(AC)){
                            ...
                            ForloopKanoDB.collection("ForloopKano")
                                    .add(attendeeToAdd)
            ...
            if (data != null){
                ...
                AttendeeCodeID.post(new Runnable() {
                    ...
                    public void run() {
                        ...
                        ForloopKanoDB.collection("Attendees")
                                .add(attendeeToAdd)
                                .addOnSuccessListener(new OnSuccessListener<DocumentReference>() {
                                    @Override
                                    public void onSuccess(DocumentReference documentReference) {
